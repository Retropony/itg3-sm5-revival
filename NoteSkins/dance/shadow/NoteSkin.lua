...
ret.Redir = function(sButton, sElement)
	...
	if Var "Button" == "Left" and sElement == "Receptor"
	then sButton = "Left";
	end
	
	if Var "Button" == "Right" and sElement == "Receptor"
	then sButton = "Left";
	end
	
	if Var "Button" == "Up" and sElement == "Receptor"
	then sButton = "Up";
	end
...
function ret.Load()
	...
	if Var "Button" == "Left" and Var "Element" == "Receptor"
	then t.BaseRotationZ = nil;
	end
	
	if Var "Button" == "Right" and Var "Element" == "Receptor"
	then t.BaseRotationZ = nil;
		 t.InitCommand=cmd(y,1;zoomx,-1);
	end
	
	if Var "Button" == "Up" and Var "Element" == "Receptor"
	then t.BaseRotationZ = nil;
	end	
